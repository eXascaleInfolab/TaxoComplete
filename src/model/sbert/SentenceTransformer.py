# based on code from https://github.com/UKPLab/sentence-transformers
import pdb
import csv
import json
import logging
...
class SentenceTransformer(nn.Sequential):
    ...
    def smart_batching_collate(self, batch):
        ...
        return sentence_features, labels, indices
            ...
            for _ in trange(steps_per_epoch, desc="Iteration", smoothing=0.05, disable=not show_progress_bar):
                ...
                if evaluation_steps > 0 and training_steps % evaluation_steps == 0:
                    if loss_value < self.best_score:
                        ...
                        self._save_loss_values(loss_value, epoch, training_steps, output_path)
    ...
    def _save_loss_values(self,loss_value,epoch,training_steps,output_path):
        self.csv_headers = ["epoch", "steps", "global_loss_value"]
        if output_path is not None:
            ...
            with open(csv_path, newline='', mode="a" if output_file_exists else 'w', encoding="utf-8") as f:
                ...
                writer.writerow([epoch, training_steps, loss_value])
    ...
    def _eval_during_training(self, evaluator, output_path, save_best_model, epoch, steps, callback):
        ...
        if evaluator is not None:
            ...
            #     if save_best_model:
            #         self.save(output_path)
            #         _ = evaluator(self, output_path=eval_path, epoch=epoch, steps=steps)
